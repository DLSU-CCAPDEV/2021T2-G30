...
* Safe Space is a diary web application that aims to provide users a safe space to store precious moments while providing an option to add their closest friends and share entries to them. 
